 ...
 * @param <E>
 */
final class ChainableInputInvoker<S, I, O, E> implements Chainable<S, I, O, E>
{
    private final Chainable<S, I, O, E> chainable;
    private final InputInvoker<? super I> invoker;

    public ChainableInputInvoker(Chainable<S, I, O, E> chainable, InputInvoker<? super I> invoker)
    {
