 ...
 * @param <E>
 */
final class ChainableSideEffect<S, I, O, E> implements Chainable<S, I, O, E>
{
    private final Chainable<S, I, O, E> chainable;
    private final SideEffect sideEffect;

    public ChainableSideEffect(Chainable<S, I, O, E> chainable, SideEffect sideEffect)
    {
    ...
    public Changer<S, E> link(final Changer<I,  O> changer)
    {
        return chainable.link(new Changer<I, O>() {
            ...
            {
                return sideEffect.process(new BoundedChanger<I, O>(changer, input));
            }
        });
    }
}
