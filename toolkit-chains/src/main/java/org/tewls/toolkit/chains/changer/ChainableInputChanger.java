 ...
 * @param <X>
 */
final class ChainableInputChanger<S, I, O, E, X> implements Chainable<S, X, O, E>
{
    private final Chainable<S, I, O, E> chainable;
    private final InputChanger<? super I, X> link;

    public ChainableInputChanger(Chainable<S, I, O, E> chainable, InputChanger<? super I, X> link)
    {
